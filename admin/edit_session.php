                    ...
                    <form action="" method="post" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="title" name="title" class="form-control" placeholder="عنوان جلسه را وارد کنید" value="<?= htmlspecialchars($session_data['title']) ?>" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="duration" class="form-label">مدت زمان جلسه (اختیاری - بر حسب دقیقه):</label>
                                <input type="number" id="duration" name="duration" class="form-control" placeholder="مدت زمان را به دقیقه وارد کنید" min="1" value="<?= $session_data['duration_minutes'] ?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="editor" class="form-label">توضیحات جلسه (اختیاری):</label>
                            <textarea id="editor" name="description" class="form-control"><?= htmlspecialchars($session_data['description']) ?></textarea>
                        </div>
