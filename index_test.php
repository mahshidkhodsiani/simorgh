  ...
  <body>
    ...
    <section class="light">
        <div class="container py-2">
            ...
            <?php
            // Adjust the query to fetch only .jpg images
            $sql = "SELECT * FROM galleries WHERE images LIKE '%.jpg' ORDER BY id DESC LIMIT 4";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <img src="<?= $image_url ?>" class="card-img-top" height="220px" width="100px"
                            alt="دوبله و صدا برداری و سینمایی">
                            <div class="card-body">
                ...
                <!-- <button class="btn btn-outline-info btn-lg">دیدن گالری</button> -->
                <?php
            } else {
                echo "0 results";
            }
