        ...
        <div class="container py-2">
          ...
          if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  $body_content = preg_replace('/<p>/', '<p style="color: black !important; margin-right: 5px !important; font-family: \'B Titr\' !important; font-size: 16px !important;">', $row['body']);
          ...
          <article class="postcard light red">
            ...
            <div class="postcard__text t-dark">
              <h1 class="postcard__title red"><a href="#"><?= $row[
                  "title"
              ] ?></a></h1>
              <div class="postcard__subtitle small">
                <time datetime="<?= $sdate->toShaDate($row["created_at"]) ?>">
