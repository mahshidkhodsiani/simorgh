...
class SDate {
    ...
    function gregorian_to_jalali($g_y, $g_m, $g_d, $mod='') {
        $g_y = (int)$this->tr_num($g_y); // Ensure the values are integers
        $g_m = (int)$this->tr_num($g_m); // Ensure the values are integers
        $g_d = (int)$this->tr_num($g_d); // Ensure the values are integers
