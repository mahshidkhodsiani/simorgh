            ...
            <div class="col-12 col-md-10">
                <div class="card border border-danger" style="border-radius: 40px;">
                    ...
                    <div class="card-body" dir="rtl" style="text-align: right;"> <!-- Ensured text-align right for RTL text -->
                        ...
                        <h1>همکاری با موسسه فرهنگی هنری هفت هنر سیمرغ</h1>
                        <p>برای ایجاد فرصت‌های جدید و همکاری‌های مثمر ثمر، **موسسه فرهنگی هنری هفت هنر سیمرغ** مشتاقانه آماده شنیدن ایده‌ها و طرح‌های شماست. ما به دنبال توسعه فعالیت‌های فرهنگی و هنری هستیم و از همکاری با متخصصان، هنرمندان و مجموعه‌های فعال در این حوزه استقبال می‌کنیم.</p>
                        ...
                        <ul>
                            <li><strong>آدرس حضوری:</strong> تهران، پل کریمخان، میرزای شیرازی، روبروی داروخانه ایثار، پلاک ۶۸، واحد ۳</li>
                            <li><strong>تلفن ثابت:</strong> ۰۲۱-۹۱۳۰۰۵۱۷</li>
                            <li><strong>واتساپ یا تلگرام:</strong> ۰۹۳۵۴۶۳۷۰۵۵</li>
                            <li><strong>اینستاگرام:</strong> <a href="https://www.instagram.com/haft_simorgh/" target="_blank">haft_simorgh@</a></li>
                            <li><strong>ایمیل:</strong> <a href="mailto:info@simorghtv.com">info@simorghtv.com</a></li>
                            <li><strong>تلفن مستقیم:</strong> ۰۲۱-۸۸۳۴۱۶۵۲</li>
                            <li><strong>سامانه پیامکی:</strong> ۳۰۰۰۱۶۳۴۳۰۰۰</li>
                        </ul>
                        <p>ما منتظر تماس و پیشنهادات ارزشمند شما هستیم تا با هم گامی موثر در اعتلای فرهنگ و هنر برداریم.</p>
                        </p>
