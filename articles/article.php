...
<head>
    ...
    <style>
        ...
        /* --- استایل ویژه سایدبار رادیو --- */
        .radio-sidebar-card {
            border: 1px solid #764ba2 !important;
        }

        .radio-sidebar-card .sidebar-header {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            color: white !important;
            border-bottom: none;
        }

        .radio-sidebar-card .sidebar-list .list-group-item:hover {
            background-color: #f3eef9;
            border-right-color: #764ba2;
            color: #764ba2;
        }

        .radio-sidebar-card .sidebar-list .list-group-item i {
            color: #764ba2;
        }

        .radio-sidebar-card .sidebar-btn {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
        }

        .radio-sidebar-card .sidebar-btn:hover {
            ...
            <div class="container mt-4">
                <div class="row" style="margin-top: 50px;">
                    ...
                    <div class="col-12 col-md-3 order-2 order-md-2 mt-5 mt-md-0">
                        ...
                        <!-- سایدبار ۲: رادیو سیمرغ -->
                        <div class="card sidebar-card radio-sidebar-card mt-4">
                            <div class="card-header sidebar-header text-center">
                                <h5 class="m-0">🎙️ رادیو سیمرغ</h5>
                            </div>
                            <div class="list-group list-group-flush sidebar-list">
                                <a href="../radios/radio_simorgh.php" class="list-group-item list-group-item-action sidebar-item">
                                    <i class="fas fa-broadcast-tower"></i> جمعه‌های سیمرغی
                                </a>
                                <a href="../radios/tehran.php" class="list-group-item list-group-item-action sidebar-item">
                                    <i class="fas fa-moon"></i> سریال صوتی شب‌های تهران
                                </a>
                                <a href="../radios/cafe_meh.php" class="list-group-item list-group-item-action sidebar-item">
                                    <i class="fas fa-coffee"></i> سریال صوتی کافه مه‌آلود
                                </a>
                            </div>
                            <div class="card-footer text-center bg-white">
                                <a href="../radios/" class="btn btn-block sidebar-btn">ورود به رادیو 🎧</a>
                            </div>
                        </div>

                        <!-- سایدبار ۳: دوره‌ها و خدمات سیمرغ -->
