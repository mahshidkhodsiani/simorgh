...
// ✅ اصلاح: اضافه کردن mobile به کوئری
...
$username = '';
$meli_code = ''; 
$mobile = ''; // ✅ تعریف متغیر جدید mobile
...
if ($result_user->num_rows > 0) {
    ...
    $mobile = $row['mobile']; // ✅ دریافت مقدار mobile
}
$stmt->close();
?>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="update_profile.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="mobile" class="form-label"><i class="bi bi-phone me-2"></i>شماره موبایل</label>
                                            <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo htmlspecialchars($mobile); ?>" required maxlength="11" pattern="09\d{9}" title="شماره موبایل باید با ۰۹ شروع و ۱۱ رقم باشد.">
                                        </div>
                                        <div class="mb-3">
