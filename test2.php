                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center mb-4 mb-md-0">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="feature-item">۷ بخش</div>
                                <div class="feature-item">در حال تکمیل</div>
                                <div class="feature-item">۱۰۰٪ رایگان</div>
                            </div>
                            
                            <div class="mt-4">
                                <a href="register.php?package=<?php echo (int)$package['id']; ?>" class="register-btn">
                                    ثبت نام در دوره
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 text-md-right">
                            ...
                            <h2 class="mb-1"><?= htmlspecialchars($package['name'], ENT_QUOTES, 'UTF-8'); ?></h2>
                ...
                <!-- فایل‌ها و سرفصل‌ها -->
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            ...
                            <p class="lead" style="max-width:95%;"><?php echo nl2br(htmlspecialchars($package['description'], ENT_QUOTES, 'UTF-8')); ?></p>
                        </div>
